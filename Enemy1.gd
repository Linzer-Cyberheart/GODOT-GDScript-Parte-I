#Script de soldado inimigo com arma de fogo.
extends "res://Scripts/NPC.gd"

onready var parent = get_parent()

#Variavel de velocidade do tiro.
export (float) var gun_speed
#Variavel da area de detectação do jogador pelo inimigo.
export (int) var detect_radius

#Variavel de velocidade do caminhar do inimigo.
var speed = 0

#Variavel que indica se o player esta na area de detectação do inimigo.
var target = null
